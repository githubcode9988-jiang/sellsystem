<html>
               ...
               <div class="row clearfix">
                   ...
                   <td>
                           <#if orderDto.getOrderStatusEnum().message!="已取消">
                               <a href="/sell/seller/order/cancel?orderID=${orderDto.getOrderId()}">取消</a></td>
                           </#if>
                   </tr>
                   </#list >
                           </tbody>
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-footer">
                   <button onclick="javascript:$('#notice').pause()" type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
   ...
   <audio id="notice" loop="loop">
         <source src="/sell/map3/song.mp3" type="audio/mpeg">
   </audio>

   <script src="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/3.3.5/js/npm.js"></script>
