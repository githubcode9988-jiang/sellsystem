        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-md-12 column">
                   ...
                   <#list infoPage.content as productInfo>
                   <tr>
                       ...
                       <td>
                           <a href="/sell/seller/product/index?productId=${productInfo.getProductId()}">修改</a></td>
                   <td>
                ...
                <div class="col-md-12 column">
                   ...
                   <#list 1..infoPage.getTotalPages() as index>
                   ...
                   <#if currentPage gte infoPage.getTotalPages()>
                   <li class="disabled"><a href="#}"></a></li>
                   <#else >
